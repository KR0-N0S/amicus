...
// Rozszerzona i ulepszona walidacja tworzenia/aktualizacji zwierzęcia
export const animalValidator: ValidationChain[] = [
...
export const inseminationValidator: ValidationChain[] = [
  body('animal_id')
...
export const bullValidator: ValidationChain[] = [
...
// Walidator dla dostawców nasienia
export const semenProviderValidator: ValidationChain[] = [
  body('name')
