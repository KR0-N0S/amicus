...
const semenProviderController = require('../controllers/semenProviderController');
 ...
 */
router.get('/public', semenProviderController.getPublicProviders);
 ...
 */
router.get('/', 
  verifyResourceAccess({ resourceType: 'semen_provider' }),
  semenProviderController.getProviders
);
 ...
 */
router.post('/', 
  // Usunięto odwołanie do semenProviderValidator, które powodowało błąd
  verifyResourceAccess({ resourceType: 'semen_provider' }),
  semenProviderController.createProvider
);
 ...
 */
router.get('/:id', 
  verifyResourceAccess({ resourceType: 'semen_provider', paramName: 'id' }),
  semenProviderController.getProvider
);
...
router.put('/:id', 
  // Usunięto odwołanie do semenProviderValidator, które powodowało błąd
  verifyResourceAccess({ resourceType: 'semen_provider', paramName: 'id' }),
  semenProviderController.updateProvider
);
...
router.delete('/:id', 
    verifyResourceAccess({ resourceType: 'semen_provider', paramName: 'id' }),
    semenProviderController.deleteProvider
);
