 ...
 * @author KR0-N0S
 * @date 2025-04-08 15:47:45
 */

import { Response, NextFunction } from 'express';
import * as db from '../config/db'; // Zmiana importu na nazwany
...
interface OrganizationModule extends Module {
  active: boolean;
 ...
 */
export const getAllModules: ControllerFunction = async (
  req: RequestWithUser,
  res: Response,
  next: NextFunction
) => {
 ...
 */
export const getOrganizationModules: ControllerFunction = async (
  req: RequestWithUser,
  res: Response,
  next: NextFunction
) => {
 ...
 */
export const updateOrganizationModules: ControllerFunction = async (
  req: RequestWithUser,
  res: Response,
  next: NextFunction
) => {
 ...
 */
export const getUserModulePermissions: ControllerFunction = async (
  req: RequestWithUser,
  res: Response,
  next: NextFunction
) => {
 ...
 */
export const updateUserModulePermissions: ControllerFunction = async (
  req: RequestWithUser,
  res: Response,
  next: NextFunction
) => {
 ...
 */
export const activateTrialPeriod: ControllerFunction = async (
  req: RequestWithUser,
  res: Response,
  next: NextFunction
) => {
 ...
 */
export const generateModuleUsageReport: ControllerFunction = async (
  req: RequestWithUser,
  res: Response,
  next: NextFunction
) => {
